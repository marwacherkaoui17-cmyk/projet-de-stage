...
import { Save, UserCog, Mail, Phone, Briefcase } from 'lucide-react';

export default function Edit({ personnel, services }) {
    ...
    return (
        <AuthenticatedLayout header={`Modifier Agent: ${personnel.nom}`}>
            <Head title="Modifier Personnel" />
