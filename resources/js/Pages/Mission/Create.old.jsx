...
export default function Create({ services, programmes, communes, forets, personnels, essences }) {
    ...
    return (
        <AuthenticatedLayout header="Nouvelle Mission">
            <Head title="Créer Mission" />
                ...
                <form onSubmit={submit} className="space-y-8 pb-12">
                    ...
                    <div className="flex justify-end gap-3 pt-6">
                        ...
                        >
                            ...
                            {processing ? 'Enregistrement...' : 'Enregistrer la Mission'}
                        </button>
                    </div>
                </form>
            </div>
